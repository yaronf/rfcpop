...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnnotAuthor.nickname'
        db.add_column('rfcpop_annotauthor', 'nickname',
                      self.gf('django.db.models.fields.CharField')(default='xxx', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnnotAuthor.nickname'
        db.delete_column('rfcpop_annotauthor', 'nickname')
